...
#include "avai_messages/msg/detail/vehicle_lights__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const avai_messages::msg::VehicleLights & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  avai_messages::msg::VehicleLights & ros_message)
{
  // Member: left_motor
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_avai_messages
max_serialized_size_VehicleLights(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avai_messages::msg::VehicleLights;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avai_messages::msg::VehicleLights *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avai_messages::msg::VehicleLights *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleLights__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const avai_messages::msg::VehicleLights *>(
...
static size_t _VehicleLights__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehicleLights(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehicleLights__callbacks = {
  "avai_messages::msg",
  "VehicleLights",
...
static rosidl_message_type_support_t _VehicleLights__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleLights__callbacks,
...
{
  return &avai_messages::msg::typesupport_fastrtps_cpp::_VehicleLights__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avai_messages, msg, VehicleLights)() {
  return &avai_messages::msg::typesupport_fastrtps_cpp::_VehicleLights__handle;
}
