...
#include "avai_messages/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avai_messages::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avai_messages::msg::Cone *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avai_messages::msg::Cone *>(
    untyped_ros_message);
...
{
  return &avai_messages::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
