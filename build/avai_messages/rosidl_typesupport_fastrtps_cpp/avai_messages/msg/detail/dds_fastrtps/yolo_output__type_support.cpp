...
#include "avai_messages/msg/detail/yolo_output__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const avai_messages::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const avai_messages::msg::YoloOutput & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  avai_messages::msg::YoloOutput & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_avai_messages
max_serialized_size_YoloOutput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        avai_messages::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = avai_messages::msg::YoloOutput;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avai_messages::msg::YoloOutput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avai_messages::msg::YoloOutput *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YoloOutput__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const avai_messages::msg::YoloOutput *>(
...
static size_t _YoloOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YoloOutput(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YoloOutput__callbacks = {
  "avai_messages::msg",
  "YoloOutput",
...
static rosidl_message_type_support_t _YoloOutput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloOutput__callbacks,
...
{
  return &avai_messages::msg::typesupport_fastrtps_cpp::_YoloOutput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avai_messages, msg, YoloOutput)() {
  return &avai_messages::msg::typesupport_fastrtps_cpp::_YoloOutput__handle;
}
