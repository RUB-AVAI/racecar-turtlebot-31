...
#include "avai_messages/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const avai_messages::msg::Target & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  avai_messages::msg::Target & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avai_messages::msg::Target;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avai_messages::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avai_messages::msg::Target *>(
    untyped_ros_message);
...
{
  return &avai_messages::msg::typesupport_fastrtps_cpp::_Target__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avai_messages, msg, Target)() {
  return &avai_messages::msg::typesupport_fastrtps_cpp::_Target__handle;
}
