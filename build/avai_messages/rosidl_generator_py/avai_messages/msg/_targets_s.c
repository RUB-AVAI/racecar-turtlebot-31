...
bool avai_messages__msg__targets__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avai_messages.msg._targets.Targets", full_classname_dest, 34) == 0);
  }
  avai_messages__msg__Targets * ros_message = _ros_message;
  {  // x_position
...
PyObject * avai_messages__msg__targets__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("avai_messages.msg._targets");
