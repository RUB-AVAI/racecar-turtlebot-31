...
bool avai_messages__msg__cone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avai_messages.msg._cone.Cone", full_classname_dest, 28) == 0);
  }
  avai_messages__msg__Cone * ros_message = _ros_message;
  {  // color
...
PyObject * avai_messages__msg__cone__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("avai_messages.msg._cone");
